...
public class DisplayChart_R_NetIncome_AllRetailers extends HttpServlet {
	...
	private JFreeChart createChart() {
		...
		// 定义数据坐标，即纵坐标
		NumberAxis Yaxis = new NumberAxis("净收益");
		...
		return new JFreeChart("各零售商每期净收益图", JFreeChart.DEFAULT_TITLE_FONT, xyplot, true);
	}
