...
public class DisplayChart_R_Total extends HttpServlet {
	...
	private JFreeChart createChart() {
		...
		return new JFreeChart("零售商"+retailerId+"的总得分走势图", JFreeChart.DEFAULT_TITLE_FONT,
				xyplot, true);
	}

	private IntervalXYDataset createDataset1() {
		IntervalXYDataset intervalxydataset1 = null;
		XYSeries xyseries1 = new XYSeries("总资产走势");
		double x = 0, y = 0;
